...
let App = /*#__PURE__*/function (_React$Component) {
  ...
  function App() {
    ...
    _this = _super.call(this); //set application state

    console.log(" start here ");

    _renderer.default._initState(_assertThisInitialized(_this));

    _renderer.default.getApplicationState().then(db => {
      console.log(" database ", db);

      _this.updateState(db);
